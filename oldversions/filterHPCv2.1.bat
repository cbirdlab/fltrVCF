...
vcftools --vcf $MAPdir/TotalRawSNPs.$CutoffCode.vcf --min-meanDP 3  --mac 3  --recode --recode-INFO-all --out $DataName.$CutoffCode.Filter00

echo
echo `date` "---------------------------FILTER001-----------------------------"
#filter raw vcf file with vcf tools

vcftools --vcf $DataName.$CutoffCode.Filter00.recode.vcf --max-missing 0.50 --mac 3 --minQ 20 --recode --recode-INFO-all --out $DataName.$CutoffCode.Filter01 
