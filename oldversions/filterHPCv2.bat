...
vcftools --vcf $MAPdir/TotalRawSNPs.$CutoffCode.vcf --max-missing 0.50 --mac 3 --minQ 30 --recode --recode-INFO-all --out $DataName.$CutoffCode.Filter01 
...
vcftools --vcf $DataName.$CutoffCode.Filter03.recode.vcf --max-missing 0.95 --maf 0.05 --recode --recode-INFO-all --out $DataName.$CutoffCode.Filter04 --min-meanDP 10
...
##$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
vcftools --vcf $DataName.$CutoffCode.Filter04.recode.vcf --keep 1.keep --missing-site --out $DataName.$CutoffCode.1
vcftools --vcf $DataName.$CutoffCode.Filter04.recode.vcf --keep 2.keep --missing-site --out $DataName.$CutoffCode.2 
#ceb this can probably speed this step up, where you plug 1 to the number of samples: seq 1 10 | parallel "vcftools --vcf $DataName.$CutoffCode.Filter04.recode.vcf --keep {}.keep --missing-site --out  $DataName.$CutoffCode.{} "

##!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

# remove loci with more than X proportion of missing data
cat $DataName.$CutoffCode.*.lmiss | mawk '!/CHR/' | mawk '$6 > 0.5' | cut -f1,2 >> $DataName.$CutoffCode.badloci
...
mawk '!/D/' $DataName.$CutoffCode.Filter10.site.depth | mawk -v x=$NumInd '{print $1/x}' > meandepthpersite
gnuplot << \EOF 
set terminal dumb size 120, 30
set autoscale
set xrange [10:150] 
...
vcftools --vcf  $DataName.$CutoffCode.Filter10.vcf --recode-INFO-all --out $DataName.$CutoffCode.Filter11 --max-meanDP 100 --exclude-positions $DataName.$CutoffCode.Filter10.lowQDloci --recode    
...
perl filter_hwe_by_pop_HPC.pl -v $DataName.$CutoffCode.Filter13.SNPs.recode.vcf -p $MAPdir/popmap.$CutoffCode -o $DataName.$CutoffCode.Filter14.HWE -h 0.001 -d $DataName -co $CutoffCode
...
cat <(mawk '/^#/' $DataName.$CutoffCode.Filter16.recode.vcf) <(paste <(mawk '!/#/' $DataName.$CutoffCode.Filter16.recode.vcf | cut -f1-5) nq <(mawk '!/#/' $DataName.$CutoffCode.Filter16.recode.vcf | cut -f7- ) )> temp
